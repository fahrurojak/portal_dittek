...
announcementTrigger.addEventListener("click", function (e) {
  e.preventDefault();
...
// Bootstrap requires explicit hover handling for submenus
...
function validateLogin() {
  ...
  if (userID && password) {
      document.forms["login"].submit(); // Submit form if both fields are filled
  } else {
